...
const BENEFITS = [
  "Перцентиль цены и $/m² вашего юнита внутри когорты",
  "Сравнение с районом, проектом и рынком Phuket целиком",
  "Графики распределения и выгрузка сводки в CSV",
];
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <h1 className="text-2xl font-medium text-ink sm:text-3xl">
              Калькулятор позиции юнита на рынке Пхукета
            </h1>
            <p className="mt-3 text-sm leading-relaxed text-muted">
              Покажем, как цена, площадь и $/m² вашего юнита выглядят на фоне
              листингов FazWaz — off-plan и вторичка. Оставьте контакты, чтобы
              открыть доступ.
            </p>
          </div>
